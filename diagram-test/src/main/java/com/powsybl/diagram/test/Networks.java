...
public final class Networks {
    ...
    public static Network createBusbarLoadNetwork() {
        Network network = Network.create("test", "test");
        Substation s = Networks.createSubstation(network, "Substation", "Substation", Country.FR);
        VoltageLevel vl = Networks.createVoltageLevel(s, "VoltageLevel1", "VoltageLevel1", TopologyKind.NODE_BREAKER, 400.0);
        //BBS node1
        vl.getNodeBreakerView().newBusbarSection()
                .setId("BBS1")
                .setNode(1)
