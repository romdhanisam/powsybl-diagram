        ...
        return vl.getBusView().getBusStream()
                .map(bus -> {
                    ...
                    if (hasFictitiousInjection(bus.getFictitiousP0())) {
                        captions.add(new BusLegendInfo.Caption(
                                valueFormatter.formatPower(bus.getFictitiousP0(), withDefaultUnit(svgParameters.getActivePowerUnit(), "MW")),
                                "fictitiousP0"));
                    }
                    if (hasFictitiousInjection(bus.getFictitiousQ0())) {
                        captions.add(new BusLegendInfo.Caption(
                                valueFormatter.formatPower(bus.getFictitiousQ0(), withDefaultUnit(svgParameters.getReactivePowerUnit(), "MVar")),
                                "fictitiousQ0"));
                    }
